...
class TemaHyperopt_two(IHyperOpt):
    """
    ...
    def buy_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_buy_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if params.get('cmo-enabled2'):
                conditions.append(dataframe['CMO'] > params['cmo-value'])
            if params.get('rsi-enabled2'):
                conditions.append(dataframe['RSI'] > params['rsi-value'])
            if params.get('rsi-change'):
                conditions.append(dataframe["RSI"].shift(0) > dataframe['RSI'].shift(1))
            if params.get('rsi-change1'):
                conditions.append(dataframe["RSI"].shift(1) > dataframe['RSI'].shift(2))
            if params.get('rsi-change2'):
                conditions.append(dataframe["RSI"].shift(2) > dataframe['RSI'].shift(3))
            if params.get('rsi-change3'):
                conditions.append(dataframe["RSI"].shift(0) > dataframe['RSI'].shift(2))
            if params.get('rsi-change4'):
                conditions.append(dataframe["RSI"].shift(1) > dataframe['RSI'].shift(3))
            

            # TRIGGERS
            if 'trigger' in params:
                if params['trigger'] == 'bb_cross_middle1':
    ...
    def indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(-40, 40, name='cmo-value'),
            Integer(5, 99, name='rsi-value'),
            Categorical([True, False], name='cmo-enabled'),
            Categorical([True, False], name='rsi-enabled'), 
            Categorical([True, False], name='cmo-enabled2'),
            Categorical([True, False], name='rsi-enabled2'),
            Categorical([True, False], name='rsi-change'),
            Categorical([True, False], name='rsi-change1'),
            Categorical([True, False], name='rsi-change2'),
            Categorical([True, False], name='rsi-change3'),
            Categorical([True, False], name='rsi-change4'),
            Categorical([ 'bb_cross_middle1','bb_cross_lower1'], name='trigger')
        ]
    ...
    def sell_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_sell_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if params.get('sell-rsi-enabled2'):
                conditions.append(dataframe['RSI'] < params['sell-rsi-value'])
            if params.get('sell-cmo-enabled2'):
                conditions.append(dataframe['CMO'] < params['sell-cmo-value'])
    ...
    def sell_indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(20, 100, name='sell-rsi-value'),
            Integer(-40, 40, name='sell-cmo-value'),
            Categorical([True, False], name='sell-rsi-enabled'),
            Categorical([True, False], name='sell-cmo-enabled'),
            Categorical([True, False], name='sell-rsi-enabled2'),
            Categorical([True, False], name='sell-cmo-enabled2'),
