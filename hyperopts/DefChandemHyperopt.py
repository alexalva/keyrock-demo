...
class DefChandemHyperopt(IHyperOpt):
    """
    ...
    def roi_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(1, 1440, name='roi_t1'),
            Integer(1, 600, name='roi_t2'),
            Integer(1, 300, name='roi_t3'),
            Real(0.001, 0.5, name='roi_p1'),
            Real(0.001, 0.7, name='roi_p2'),
            Real(0.001, 0.9, name='roi_p3')
        ]
