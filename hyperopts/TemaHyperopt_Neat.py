...
class TemaHyperoptNeat(IHyperOpt):
    """
    ...
    def buy_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_buy_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if 'trigger' in params:
                if params['trigger'] == 'bb_cross_lower':
    ...
    def indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(-10, 25, name='cmo-value'),
            Categorical([True], name='cmo-enabled'),
            Categorical(["bb_cross_lower"], name='trigger')
        ]
    ...
    def sell_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_sell_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if 'sell-trigger' in params:
                if params['sell-trigger'] == 'sell-cmo':
                    conditions.append(qtpylib.crossed_below(dataframe["CMO"],params['sell-cmo-value']))
    ...
    def sell_indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(-70, -35, name='sell-cmo-value'),
            Categorical(['sell-cmo'], name='sell-trigger')
        ]
    ...
    def roi_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(10, 1800, name='roi_t1'),
            Integer(10, 1700, name='roi_t2'),
            Integer(10, 1600, name='roi_t3'),
    ...
    def populate_buy_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            ...
            (qtpylib.crossed_above(dataframe["TEMA"], dataframe["bb_lowerbandTA"]))
            & 
              (dataframe['CMO']>-0) 
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
             ...
             ((qtpylib.crossed_below(dataframe["CMO"],-50)))
