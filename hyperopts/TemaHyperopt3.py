...
class TemaHyperopt3(IHyperOpt):
    ...
    def indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(-5, 5, name='cmo-value'),
            Categorical([True, True], name='cmo-enabled'),
    ...
    def sell_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_sell_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if 'sell-trigger' in params:
                if params['sell-trigger'] == 'sell-cmo-shift':
                    conditions.append(
                        (qtpylib.crossed_below(dataframe["CMO"],params['sell-cmo-value'])) 
                            |
                            (qtpylib.crossed_below(dataframe["CMO"],params['sell-cmo-value2']))
                    )
    ...
    def sell_indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(20, 25, name='sell-cmo-value'),
            Integer(-25, -20, name='sell-cmo-value2'),
            Categorical([True, True], name='sell-cmo-enabled'),
            Categorical([True, True], name='sell-cmo-enabled2'),
            Categorical(['sell-cmo-shift'], name='sell-trigger')
        ]
