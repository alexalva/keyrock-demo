...
class TemaMasterHyperopt2(IHyperOpt):
    """
    ...
    def populate_indicators(dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        """
        dataframe['CMO'] = ta.CMO(dataframe, timeperiod = 20)
    ...
    def buy_strategy_generator(params: Dict[str, Any]) -> Callable:
        ...
        def populate_buy_trend(dataframe: DataFrame, metadata: dict) -> DataFrame:
            ...
            if 'coeffv-enabled' in params and params['coeffv-enabled']:
                conditions.append(dataframe['CMO'] > params['coeffv-value'])
    ...
    def indicator_space() -> List[Dimension]:
        ...
        return [
            ...
            Real(.001, .02, name='coeffv-value'),
            Categorical([True, False], name='coeffv-enabled'),
    ...
    def sell_indicator_space() -> List[Dimension]:
        ...
        """
        return [
            Integer(-75, -35, name='sell-cmo-value'),
    ...
    def roi_space() -> List[Dimension]:
        ...
        return [
            ...
            Integer(10, 600, name='roi_t2'),
            Integer(10, 400, name='roi_t3'),
            Real(0.01, 0.40, name='roi_p1'),
            Real(0.01, 0.70, name='roi_p2'),
            Real(0.01, 0.99, name='roi_p3'),
        ]
    ...
    def populate_sell_trend(self, dataframe: DataFrame, metadata: dict) -> DataFrame:
        ...
        dataframe.loc[
            (
            (qtpylib.crossed_below(dataframe["CMO"],-70))  
            ),
            'sell'] = 1
        return dataframe